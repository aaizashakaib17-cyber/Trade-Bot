...
<body>
    ...
    <div class="card">
        <h1>About Trade Bot</h1>
        <p>Trade Bot is an advanced algorithmic trading assistant powered by AI and the Alpaca API. It helps you monitor your paper portfolio, analyze live market data, and streamline your trading workflow seamlessly from a clean, modern web interface.</p>
    </div>
</body>
</html>
    """
...
<body>
    ...
    <div class="card">
        <h1>Contact Us</h1>
        <p>Have feedback or questions? Send us a note below.</p>
